...
def recommend_product_images_for_age_gender_with_fallback(age, gender, data_path):
    ...
    # Ensure correct product-URL association
    ...
    # Debugging line to print out the product name and URL being added
        print(f"Product: {product_name}, URL: {product_url}")
...
def extract_age(age_str):
    # Use regular expression to extract the numerical age from the age string
...
def recommend_products():
    ...
    try:
        ...
        data_path = 'path/to/your/User_data.csv'
